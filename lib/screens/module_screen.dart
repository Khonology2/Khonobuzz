...
class _ModuleScreenState extends State<ModuleScreen> {
  ...
  final TextEditingController _pdhTokenController = TextEditingController();
  bool _isGeneratingPDHToken = false;
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      TextField(
                                        controller: _pdhTokenController,
                                        readOnly: true,
                                        style: const TextStyle(
                                          color: Colors.white,
                                          fontFamily: 'Poppins',
                                      ...
                                      SizedBox(
                                        ...
                                        child: ElevatedButton(
                                          ...
                                          onPressed: _isGeneratingPDHToken
                                              ? null
                                              : () async {
                                                  final messenger =
                                                      ScaffoldMessenger.of(
                                                  ...
                                                  try {
                                                    ...
                                                    if (mounted) {
                                                      setState(() {
                                                        _isGeneratingPDHToken =
                                                            false;
                                                      });
                                                    }
                                                  }
                                                },
                                          child: _isGeneratingPDHToken
                                              ? const SizedBox(
                                                  width: 20,
                                                  height: 20,
                                                  child:
